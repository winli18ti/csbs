    ...
    public function run(): void
    {
        $arr = array(
          [
            ...
            'bill' => 250000,
            'status' => 'lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-09-15 00:00:00'),
          ...
          [
            ...
            'bill' => 66000,
            'status' => 'belum lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-10-15 00:00:00'),
          ...
          [
            ...
            'bill' => 75000,
            'status' => 'belum lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-11-15 00:00:00'),
          ...
          [
            ...
            'bill' => 210000,
            'status' => 'lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-08-15 00:00:00'),
          ...
          [
            ...
            'bill' => 205000,
            'status' => 'lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2022-10-01 00:00:00'),
          ...
          [
            ...
            'bill' => 200000,
            'status' => 'belum lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2022-11-01 00:00:00'),
          ...
          [
            ...
            'bill' => 75000,
            'status' => 'belum lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2022-12-01 00:00:00'),
          ...
          [
            ...
            'bill' => 75000,
            'status' => 'belum lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-01-01 00:00:00'),
          ...
          [
            ...
            'bill' => 75000,
            'status' => 'lunas',
            'billdate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-09-01 00:00:00'),
            'duedate' => Carbon::createFromFormat('Y-m-d H:i:s', '2023-09-30 23:59:59'),
