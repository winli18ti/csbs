      ...
      <div class="row justify-content-center">
        <div class="col-lg-9 col-xl-8 col-xxl-7">
          <button class="btn btn-outline-primary btn-sm"
            wire:click.prevent="navigate('complain')">
            Kembali
          </button>
          ...
          <form wire:submit="complainCreate" enctype="multipart/form-data">
            ...
            <fieldset class="border border-2 border-danger-subtle rounded-3 px-3 pb-3 my-2">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-7 col-md-8">
                    ...
                    wire:model.live="complain_status" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
                        <option value="">-- Pilih Status Komplain --</option>
                        <option value="tunggu">Tunggu</option>
                        <option value="proses">Proses</option>
                        @if($currentTab === 'complaineditform') <option value="selesai">Selesai</option> @endif
                    </select>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-7 col-md-8">
                    ...
                    wire:model.live="complain_priority" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                    ...
                    wire:model.live="service_type" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                    ...
                    wire:model.live="report" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                    ...
                    wire:model.live="source" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                  <input type="text" name="reporter" id="reporter" class="form-control form-control-sm"
                    wire:model.live="reporter" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                  <input type="text" name="report_subject" id="report_subject" class="form-control form-control-sm"
                    wire:model.live="report_subject" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                  <textarea id="customer_complain" rows="2" class="form-control form-control-sm"
                    wire:model.live="customer_complain" {{ $currentTab === 'complainviewform'  ? 'disabled' : ''}}></textarea>
              ...
              <div class="row">
                ...
                <div class="col-7 col-md-8">
                  <textarea id="completion" rows="2" class="form-control form-control-sm"
                    wire:model.live="completion" {{$currentTab === 'complainform' || $currentTab === 'complainviewform'  ? 'disabled' : ''}}>
                  </textarea>
            ...
            <fieldset class="border border-2 border-danger-subtle rounded-3 text-center p-3 my-3">
              @if($currentTab === 'complainform')
                <button type="submit" class="btn btn-outline-primary btn-sm">
                  Tambah
                </button>
              @elseif($currentTab === 'complaineditform')
                <button type="button" wire:click.prevent="complainUpdate" class="btn btn-outline-primary btn-sm">
                  Ubah
                </button>
              @endif
              <button type="button" wire:click.prevent="navigate('complain')" class="btn btn-outline-primary btn-sm">
                Kembali
              </button>
            </fieldset>
          </form>
